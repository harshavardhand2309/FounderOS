...
// No dashboard props here — production shows the trailer only. The
// /tennis/analytics route still resolves for a direct link.
export default function TennisView({ navRef, videoRef, onWatchTrailer, onPrepareTrailer, onCancelTrailer }) {
